...
function saveEnemies(){
	...
	var enemies = [];
	enemies.push(initEnemy(101,   100,  100,  100, 1, 400, 2.0, 60,  5, 20, 2,  4, enemy_shapes[0], bullet_shapes[0]));
	enemies.push(initEnemy(102,   200,  141,  141, 3, 200, 2.0, 80, 10, 10, 2,  2, enemy_shapes[1], bullet_shapes[0]));
	enemies.push(initEnemy(103,   400,  200,  200, 2, 300, 2.0, 70, 15, 30, 2,  6, enemy_shapes[2], bullet_shapes[0]));
	enemies.push(initEnemy(104,   800,  282,  282, 3, 300, 2.0, 70, 20, 20, 2,  4, enemy_shapes[3], bullet_shapes[1]));
	enemies.push(initEnemy(105,  1600,  400,  400, 4, 200, 2.0, 60, 25, 10, 2,  3, enemy_shapes[4], bullet_shapes[1]));
	enemies.push(initEnemy(106,  3200,  565,  565, 4, 300, 2.0, 60, 30, 40, 2,  8, enemy_shapes[5], bullet_shapes[1]));
	enemies.push(initEnemy(107,  6400,  800,  800, 2, 500, 2.0, 80, 35, 40, 2,  8, enemy_shapes[6], bullet_shapes[2]));
	enemies.push(initEnemy(108, 12800, 1131, 1131, 5, 200, 2.0, 60, 40, 30, 2,  6, enemy_shapes[7], bullet_shapes[2]));
	enemies.push(initEnemy(109, 25600, 1600, 1600, 3, 500, 2.0, 90, 45, 40, 2,  8, enemy_shapes[8], bullet_shapes[2]));
	enemies.push(initEnemy(110, 51200, 2262, 2262, 2, 400, 2.0, 60, 50, 30, 2, 12, enemy_shapes[9], bullet_shapes[3]));

	enemies.push(initEnemy(1,  5,  2,  2, 1, 400, 1.0, 60, 1, 80, 2, 2, enemy_shapes[0], bullet_shapes[0]));
	enemies.push(initEnemy(2, 10,  5,  5, 3, 200, 1.0, 80, 2, 40, 2, 1, enemy_shapes[1], bullet_shapes[0]));
	enemies.push(initEnemy(3, 15,  7,  7, 2, 300, 1.0, 70, 3, 90, 2, 3, enemy_shapes[2], bullet_shapes[0]));
	enemies.push(initEnemy(4, 20, 10, 10, 3, 300, 1.0, 70, 4, 80, 2, 2, enemy_shapes[3], bullet_shapes[1]));
	enemies.push(initEnemy(5, 25, 12, 12, 4, 200, 1.0, 60, 5, 60, 2, 1, enemy_shapes[4], bullet_shapes[1]));
	enemies.push(initEnemy(6, 30, 15, 15, 4, 300, 1.0, 60, 6, 80, 2, 4, enemy_shapes[5], bullet_shapes[1]));
	enemies.push(initEnemy(7, 35, 17, 17, 2, 500, 1.0, 80, 7, 80, 2, 4, enemy_shapes[6], bullet_shapes[2]));
	enemies.push(initEnemy(8, 40, 20, 20, 5, 200, 1.0, 60, 8, 60, 2, 3, enemy_shapes[7], bullet_shapes[2]));
	enemies.push(initEnemy(9, 45, 22, 22, 3, 500, 1.0, 90, 9, 80, 2, 4, enemy_shapes[8], bullet_shapes[2]));

	enemies.push(initEnemy(10, 50, 25, 25, 1, 400, 1.0, 60, 10, 80, 2, 2, enemy_shapes[0], bullet_shapes[0]));
	enemies.push(initEnemy(11, 55, 27, 27, 3, 200, 1.0, 80, 11, 40, 2, 1, enemy_shapes[1], bullet_shapes[0]));
	enemies.push(initEnemy(12, 60, 30, 30, 2, 300, 1.0, 70, 12, 90, 2, 3, enemy_shapes[2], bullet_shapes[0]));
	enemies.push(initEnemy(13, 65, 32, 32, 3, 300, 1.0, 70, 13, 80, 2, 2, enemy_shapes[3], bullet_shapes[1]));
	enemies.push(initEnemy(14, 70, 35, 35, 4, 200, 1.0, 60, 14, 60, 2, 1, enemy_shapes[4], bullet_shapes[1]));
