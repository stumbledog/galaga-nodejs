...
function saveEnemies(){
	...
	enemies.push(initEnemy(1,  5,  2,  2, 1, 400, 1.0, 60, 1, 40, 2, 2, enemy_shapes[0], bullet_shapes[0]));
	enemies.push(initEnemy(2, 10,  5,  5, 3, 200, 1.0, 80, 2, 20, 2, 1, enemy_shapes[1], bullet_shapes[0]));
	enemies.push(initEnemy(3, 15,  7,  7, 2, 300, 1.0, 70, 3, 60, 2, 3, enemy_shapes[2], bullet_shapes[0]));
	enemies.push(initEnemy(4, 20, 10, 10, 3, 300, 1.0, 70, 4, 40, 2, 2, enemy_shapes[3], bullet_shapes[1]));
	enemies.push(initEnemy(5, 25, 12, 12, 4, 200, 1.0, 60, 5, 30, 2, 1, enemy_shapes[4], bullet_shapes[1]));
